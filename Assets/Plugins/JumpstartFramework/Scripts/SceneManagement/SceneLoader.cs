...
public class SceneLoader : MonoBehaviour
{
	...
	[SerializeField] private LoadGameEventSO _loadMenu = default;
	[SerializeField] private LoadGameEventSO _coldStartupLocation = default;

	[Header("Broadcasting on")]
	[SerializeField] private BooleanGameEventSO _toggleLoadingScreen = default;
	[SerializeField] private GameEventSO _onSceneReady = default; //picked up by the SpawnSystem
	[SerializeField] private FadeEventSO _fadeRequestChannel = default;
	...
	[SerializeField] private GameSceneSO _currentlyLoadedScene;
